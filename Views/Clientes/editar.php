...
pues el array cliente viene desde el controlador,
...
<body class="bg-light">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= APP_URL ?>/index.php?controller=clientes&action=index">Clientes</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold"><i class="fa-solid fa-pen-to-square"></i> Editar Cliente</h4>
            <a href="<?= APP_URL ?>/index.php?controller=clientes&action=index" class="btn btn-secondary">
        ...
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <form action="<?= APP_URL ?>/index.php?controller=clientes&action=actualizar" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="nombre"
                                value="<?= htmlspecialchars($cliente['nombre']) ?>" required autofocus>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-semibold">RUC <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="ruc"
                                value="<?= htmlspecialchars($cliente['ruc']) ?>" required maxlength="20">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Teléfono</label>
                            <input type="text" class="form-control" name="telefono"
                                value="<?= htmlspecialchars($cliente['telefono']) ?>" maxlength="20">
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="<?= APP_URL ?>/index.php?controller=clientes&action=index" class="btn btn-secondary"><i class="fa-solid fa-xmark"></i> Cancelar</a>
                        <button type="submit" class="btn btn-warning"><i class="fa-solid fa-floppy-disk"></i> Actualizar Cliente</button>
                    </div>
