...
<body class="bg-light">
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold"><i class="fa-solid fa-folder"></i> Proyectos</h4>
            <a href="<?= APP_URL ?>/index.php?controller=proyectos&action=crear" class="btn btn-primary">
        ...
        <form action="<?= APP_URL ?>/index.php" method="GET" class="mb-4">
            <input type="hidden" name="controller" value="proyectos">
            ...
            <div class="input-group">
                ...
                <a href="<?= APP_URL ?>/index.php?controller=proyectos&action=index" class="btn btn-outline-secondary"><i class="fa-solid fa-xmark"></i> Limpiar</a>
            </div>
        </form>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php if (empty($proyectos)): ?>
                            <tr>
                                <td colspan="8" class="text-center text-muted py-4">No se encontraron proyectos.</td>
                            </tr>
                        <?php else: ?>
                            <?php foreach ($proyectos as $proyecto): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        $badge = $badges[$proyecto['estado']] ?? 'secondary';
                                        ?>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= APP_URL ?>/index.php?controller=proyectos&action=editar&id=<?= $proyecto['id'] ?>"
                                            class="btn btn-sm btn-warning"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
                                        <a href="<?= APP_URL ?>/index.php?controller=proyectos&action=eliminar&id=<?= $proyecto['id'] ?>"
                                            class="btn btn-sm btn-danger"
                                            onclick="return confirm('¿Estás seguro de eliminar este proyecto?')"><i class="fa-solid fa-trash"></i> Eliminar</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
