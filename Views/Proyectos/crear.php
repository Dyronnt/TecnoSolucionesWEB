...
pues el array clientes viene desde el controlador,
...
<head>
    ...
    <title>Nuevo Proyecto - <?= APP_NAME ?></title>
...
<body class="bg-light">
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold"><i class="fa-solid fa-folder-plus"></i> Nuevo Proyecto</h4>
        ...
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <form action="<?= APP_URL ?>/index.php?controller=proyectos&action=guardar" method="POST">
